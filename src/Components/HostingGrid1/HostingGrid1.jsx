  ...
  return (
    <div className=' md:px-16 px-6 my-8 w-full flex lg:flex-row flex-col gap-16 justify-center items-center'>
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <p className=' text-gray-400 text-justify my-3'>Looking to create a modern, fast, and responsive website for your business, blog, portfolio, or restaurant? We build professional websites using React.js and Tailwind CSS, ensuring a seamless user experience across all devices.
